...
test('V5 creates versioned assignment tables without audio persistence columns',()=>{
...
test('HTTP assignment API creates data and backup includes assignment history',async()=>{
  ...
  try{
    ...
    assert.equal(health.schema,'SIDES-API-V4');
    ...
    assert.equal(backup.schemaVersion,'SIDES-EXPORT-V4');
